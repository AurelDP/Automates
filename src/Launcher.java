...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		if (namesTxtFiles.size() != 0) {
			...
			System.out.print("Choisissez l'automate � traiter parmi la liste suivante :\n");
			...
			do {
				System.out.print("\nVotre choix (entrez le num�ro de l'automate) : ");
			...
			*/
			...
			if (words.length != 0) {
				System.out.println("Mots entr�s :");
				for (String w : words) {
					if (w.matches("[*]+"))
				...
				System.out.println("Aucun mot n'a �t� entr�...");
			}
			*/
			
						
			/*
			 * L'automate g�n�r� dans le fichier txt est stock� dans la variable "automaton"
			 * Vous pouvez faire vos tests � partir de cet objet directement (vous pouvez ajouter un .txt "test" dans le dossier "automates"
			 * pour ajouter votre propre automate)
			 * 
			 * METTRE ICI LES TESTS DES ALGOS (D�terminisation, etc)
			 * Les m�thodes seront �crites dans les classes correspondantes
			 */
